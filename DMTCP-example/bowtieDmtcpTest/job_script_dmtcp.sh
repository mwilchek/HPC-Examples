...
dmtcp_launch --new-coordinator --rm --interval 5 bowtie2 --local -x ../bowtie2/example/index/lambda_virus -U ../bowtie2/example/reads/longreads.fq -S eg3.sam -p 1 --quiet
